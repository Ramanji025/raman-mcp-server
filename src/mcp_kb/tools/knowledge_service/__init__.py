...
class KnowledgeService(CoreMixin, ServiceOverviewMixin, DefectFeatureMixin, SearchMixin, ArchitectureMixin, InspectionMixin, CapabilitiesMixin, DependentsMixin, OnboardingMixin, ContractsMixin, KtMixin, QualityMixin, CodeIntelMixin, RcaMixin, AskMixin, PlatformMixin):
